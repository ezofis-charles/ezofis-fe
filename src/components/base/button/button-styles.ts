...
export function getVariantClassName(
  ...
  const className = tv({
    base: 'squircle-md flex shrink-0 cursor-pointer appearance-none items-center rounded border border-transparent font-medium outline-primary-8 transition-colors select-none focus-visible:outline-2 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 data-loading:pointer-events-none data-loading:opacity-75',
    compoundVariants: [
      {
