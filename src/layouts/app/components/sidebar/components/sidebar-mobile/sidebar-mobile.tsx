...
export const SidebarMobile = ({ menuGroup }: Props) => {
  return (
    <div className='fixed inset-x-0 bottom-0 z-1 flex h-16 items-center justify-between rounded-t-2xl bg-linear-to-b from-surface-raised px-4 ring ring-gray-4'>
